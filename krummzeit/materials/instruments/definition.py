...
harpsichord = abjad.instrumenttools.Harpsichord(
    ...
    short_instrument_name_markup=short_instrument_name('Hpschd.'),
    )
...
instruments = abjad.TypedOrderedDict([
    ...
    (
        ...
        abjad.instrumenttools.ClarinetInEFlat(
            ...
            short_instrument_name_markup=short_instrument_name('Cl. (Eb)'),
            )
        ),
    (
        'harpsichord', 
    ...
    (
        ...
        abjad.instrumenttools.Xylophone(
            ...
            short_instrument_name_markup=short_instrument_name('Xyl.'),
            )
        ),
    ])
