...
segment_maker.copy_specifier(
    (cl, 16),
    baca.tools.SimpleScope(va, (16, 16)),
    )
...
segment_maker.copy_specifier(
    (cl, 16),
    baca.tools.SimpleScope(vc, (16, 16)),
    )
...
segment_maker.copy_specifier(
    (cl, 16),
    baca.tools.SimpleScope(pf, (16, 18)),
    )
...
segment_maker.copy_specifier(
    (ob, 18),
    baca.tools.SimpleScope(vn, (18, 18)),
    )
