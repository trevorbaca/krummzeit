...
### harpsichord [B1-10] octave displacement ###
segment_maker.make_music_handler(
    scope=(pf, (1, 10)),
    specifier=makers.DisplacementSpecifier(
        displacements=[
...
wide_fifth_octave = pitchtools.Registration(
    [('[A0, F#4)', 4), ('[F#4, C8]', 18)]
    )

### harpsichord [B1-10] register ###
segment_maker.make_music_handler(
    scope=(pf, (1, 8)),
    specifier=makers.RegistrationSpecifier(
        registration=wide_fifth_octave,
        ),
    )
