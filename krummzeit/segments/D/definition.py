...
tempo_specifier = baca.TempoSpecifier([
    (1, krummzeit.tempi['36']),
    (4, abjad.Accelerando()),
    (8, krummzeit.tempi['72/108']),
    (9, krummzeit.tempi['72']),
    (9, krummzeit.metric_modulations['4.=4']),
    (9, abjad.Accelerando()),
    (10, krummzeit.tempi['108']),
    ])
...
segment_maker.copy_specifier(
    (va, 4),
    baca.SimpleScope(vn, (6, 6)),
    )

segment_maker.copy_specifier(
    (va, 4),
    baca.SimpleScope(vc, (6, 6)),
...
segment_maker.copy_specifier(
    (va, 5),
    baca.SimpleScope(vn, (7, 7)),
    )

segment_maker.copy_specifier(
    (va, 5),
    baca.SimpleScope(vc, (7, 7)),
...
segment_maker.copy_specifier(
    (vn, 11),
    baca.SimpleScope(va, (11, 11)),
    )

segment_maker.copy_specifier(
    (vn, 11),
    baca.SimpleScope(vc, (11, 11)),
    )
