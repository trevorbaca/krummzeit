...
maker(
    baca.timeline([
        ('Violin Music Voice', 2, 4),
        ('Viola Music Voice', 2, 4),
        ('Cello Music Voice', 2, 4),
        ]),
    baca.pitches(pcs),
    )
...
maker(
    baca.make_scopes(['Oboe Music Voice', 'Clarinet Music Voice'], [(3, 6)]),
    baca.pitches('D5'),
    )
...
maker(
    baca.make_scopes(['Piano Music Voice', 'Percussion Music Voice'], [8]),
    baca.pitches('F#6'),
    )
