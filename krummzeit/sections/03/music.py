...
def perc(m):
    ...
    with baca.scope(m[21, 27]) as o:
        ...
        baca.markup(o.pleaf(0), r"\baca-boxed-slate-scrape-markup")
...
def make_layout():
    ...
    layout = baca.layout.Layout(
        ...
        baca.layout.Page(
            7,
            baca.layout.System(35, y_offset=y_offset, distances=distances),
        ),
        baca.layout.Page(
            8,
        ...
        baca.layout.Page(
            9,
            baca.layout.System(43, y_offset=y_offset, distances=distances),
        ),
