...
#    )
#
#segment_maker.copy_music_maker(vn, 9, stages=11)
#segment_maker.copy_music_maker(vn, 9, stages=13)
#segment_maker.copy_music_maker(vn, 9, stages=15)