...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.11.Percussion.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.11.Percussion.Music_Staff = {
    ...
    \context Voice = "Percussion.MusicVoice"
      %! krummzeit.make_empty_score()
      %! baca.path.extern()
    { \number.11.Percussion.MusicVoice }
    % CLOSING:
    % COMMANDS:
