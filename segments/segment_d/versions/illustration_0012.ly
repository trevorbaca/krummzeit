		...
		\context PercussionSectionStaffGroup = "Percussion Section Staff Group" <<
			...
			\context PercussionMusicStaff = "Percussion Staff" {
				\context PercussionMusicVoice = "Percussion Music Voice" {
					...
					\clef "percussion"
					\set Staff.instrumentName = \markup { Snare drum }
					\set Staff.shortInstrumentName = \markup { Sn. Dr. }
					\stopStaff
					...
					c'8 :32
					\once \override StemTremolo #'extra-offset = #'(0 . 0)
					\set Staff.instrumentName = \markup { Tam-tam }
					\set Staff.shortInstrumentName = \markup { Tam. }
					r8
					\once \override StemTremolo #'extra-offset = #'(0 . 0)
					r8
					\once \override StemTremolo #'extra-offset = #'(0 . 0)
