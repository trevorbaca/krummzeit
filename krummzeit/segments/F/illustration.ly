    ...
    \context Score = "Score" \with {
        ...
        \context GlobalContext = "GlobalContext" <<
            \context GlobalSkips = "GlobalSkips" {
                ...
                \time 9/8 %! PERSISTENT_TIME_SIGNATURE_COMMAND:7
                \mark #6
            ...
            \context PercussionSectionStaffGroup = "PercussionSectionStaffGroup" <<
                ...
                \context PercussionMusicStaff = "PercussionMusicStaff" {
                    \context PercussionMusicVoice = "PercussionMusicVoice" {
                        ...
                        \once \override Staff.StaffSymbol.line-count = 5 %! PERSISTENT_STAFF_LINES_COMMAND:8
                        \startStaff %! PERSISTENT_STAFF_LINES_COMMAND:8
                        \override DynamicLineSpanner.staff-padding = #'6
                        \set PercussionMusicStaff.instrumentName = \markup { %! PERSISTENT_INSTRUMENT_COMMAND:4
                            \hcenter-in %! PERSISTENT_INSTRUMENT_COMMAND:4
                                #16 %! PERSISTENT_INSTRUMENT_COMMAND:4
                                Xylophone %! PERSISTENT_INSTRUMENT_COMMAND:4
                            } %! PERSISTENT_INSTRUMENT_COMMAND:4
                        \set PercussionMusicStaff.shortInstrumentName = \markup { %! PERSISTENT_INSTRUMENT_COMMAND:4
                            \hcenter-in %! PERSISTENT_INSTRUMENT_COMMAND:4
                                #10 %! PERSISTENT_INSTRUMENT_COMMAND:4
                                Xyl. %! PERSISTENT_INSTRUMENT_COMMAND:4
                            } %! PERSISTENT_INSTRUMENT_COMMAND:4
                        \clef "percussion" %! EXPLICIT_CLEF_COMMAND:14
                        \once \override PercussionMusicStaff.InstrumentName.color = #(x11-color 'green) %! PERSISTENT_INSTRUMENT_COLOR:1
                        \once \override PercussionMusicStaff.StaffSymbol.color = #(x11-color 'green) %! PERSISTENT_STAFF_LINES_COLOR:7
                        \once \override PercussionMusicVoice.DynamicText.color = #(x11-color 'green) %! PERSISTENT_DYNAMIC_COLOR:9
                            ...
                            \column
                                {
                                    ...
                                    %%%                 xylophone %! PERSISTENT_INSTRUMENT_CHANGE_MARKUP:2
                                    %%%     } %! PERSISTENT_INSTRUMENT_CHANGE_MARKUP:2
                                            ...
                                            \with-color %! PERSISTENT_INSTRUMENT_CHANGE_COLORED_MARKUP:3
                                                ...
                                                \override %! PERSISTENT_INSTRUMENT_CHANGE_COLORED_MARKUP:3
                                                    ...
                                                    \box %! PERSISTENT_INSTRUMENT_CHANGE_COLORED_MARKUP:3
                                                        xylophone %! PERSISTENT_INSTRUMENT_CHANGE_COLORED_MARKUP:3
                                        } %! PERSISTENT_INSTRUMENT_CHANGE_COLORED_MARKUP:3
                                }
                            }
                        \set PercussionMusicStaff.instrumentName = \markup { %! PERSISTENT_INSTRUMENT_SHADOW_COMMAND:6
                            \hcenter-in %! PERSISTENT_INSTRUMENT_SHADOW_COMMAND:6
                                #16 %! PERSISTENT_INSTRUMENT_SHADOW_COMMAND:6
                                Xylophone %! PERSISTENT_INSTRUMENT_SHADOW_COMMAND:6
                            } %! PERSISTENT_INSTRUMENT_SHADOW_COMMAND:6
                        \set PercussionMusicStaff.shortInstrumentName = \markup { %! PERSISTENT_INSTRUMENT_SHADOW_COMMAND:6
                            \hcenter-in %! PERSISTENT_INSTRUMENT_SHADOW_COMMAND:6
                                #10 %! PERSISTENT_INSTRUMENT_SHADOW_COMMAND:6
                                Xyl. %! PERSISTENT_INSTRUMENT_SHADOW_COMMAND:6
                            } %! PERSISTENT_INSTRUMENT_SHADOW_COMMAND:6
                        \override PercussionMusicStaff.InstrumentName.color = #(x11-color 'DarkGreen) %! PERSISTENT_INSTRUMENT_SHADOW_COLOR:5
