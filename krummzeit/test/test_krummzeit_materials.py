...
materials_path = os.path.join(krummzeit.__path__[0], 'materials')
...
def test_krummzeit_materials_01(material_path):
...
def test_krummzeit_materials_02():
...
def test_krummzeit_materials_03():
