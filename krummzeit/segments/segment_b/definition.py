...
segment_maker.copy_specifier(
    (va, 15),
    baca.tools.SimpleScope(vc, (15, 17)),
...
segment_maker.copy_specifier(
    (va, 20),
    baca.tools.SimpleScope(vc, (20, 20)),
...
segment_maker.copy_specifier(
    (va, 20),
    baca.tools.SimpleScope(vn, (20, 20)),
...
segment_maker.copy_specifier(
    (va, 20),
    baca.tools.SimpleScope(pf, (20, 22)),
