                ...
                ^ \markup { % REDUNDANT_METRONOME_MARK:4
                    ...
                    \upright % REDUNDANT_METRONOME_MARK:4
                        { % REDUNDANT_METRONOME_MARK:4
                            = % REDUNDANT_METRONOME_MARK:4
                            144 % REDUNDANT_METRONOME_MARK:4
                        } % REDUNDANT_METRONOME_MARK:4
                    } % REDUNDANT_METRONOME_MARK:4
                ...
                \context PianoMusicStaff = "PianoMusicStaff" {
                    \context PianoMusicVoice = "PianoMusicVoice" {
                            ...
                            \column
                                {
                                    ...
                                    %%%             #'(box-padding . 0.75) %! REAPPLIED_INSTRUMENT_ALERT:7
                                    %%%             \box %! REAPPLIED_INSTRUMENT_ALERT:7
                                    %%%                 harpsichord %! REAPPLIED_INSTRUMENT_ALERT:7
                                    %%%     } %! REAPPLIED_INSTRUMENT_ALERT:7
                                    \line %! REAPPLIED_INSTRUMENT_ALERT_WITH_COLOR:8
                                        { %! REAPPLIED_INSTRUMENT_ALERT_WITH_COLOR:8
                                            \with-color %! REAPPLIED_INSTRUMENT_ALERT_WITH_COLOR:8
                                                ...
                                                \override %! REAPPLIED_INSTRUMENT_ALERT_WITH_COLOR:8
                                                    #'(box-padding . 0.75) %! REAPPLIED_INSTRUMENT_ALERT_WITH_COLOR:8
                                                    \box %! REAPPLIED_INSTRUMENT_ALERT_WITH_COLOR:8
                                                        harpsichord %! REAPPLIED_INSTRUMENT_ALERT_WITH_COLOR:8
                                        } %! REAPPLIED_INSTRUMENT_ALERT_WITH_COLOR:8
                                }
                            }
                        \set PianoMusicStaff.instrumentName = \markup { %! REAPPLIED_INSTRUMENT_REDRAW:11
                            \hcenter-in %! REAPPLIED_INSTRUMENT_REDRAW:11
                                #16 %! REAPPLIED_INSTRUMENT_REDRAW:11
                                Harpsichord %! REAPPLIED_INSTRUMENT_REDRAW:11
                            } %! REAPPLIED_INSTRUMENT_REDRAW:11
                        \set PianoMusicStaff.shortInstrumentName = \markup { %! REAPPLIED_INSTRUMENT_REDRAW:11
                            \hcenter-in %! REAPPLIED_INSTRUMENT_REDRAW:11
                                #10 %! REAPPLIED_INSTRUMENT_REDRAW:11
                                Hpschd. %! REAPPLIED_INSTRUMENT_REDRAW:11
                            } %! REAPPLIED_INSTRUMENT_REDRAW:11
                        ...
                        \times 4/7 {
                                ...
                                \column
                                    {
                                        ...
                                        %%%             #'(box-padding . 0.75) %! REDUNDANT_INSTRUMENT_ALERT:7
                                        %%%             \box %! REDUNDANT_INSTRUMENT_ALERT:7
                                        %%%                 harpsichord %! REDUNDANT_INSTRUMENT_ALERT:7
                                        %%%     } %! REDUNDANT_INSTRUMENT_ALERT:7
                                        \line %! REDUNDANT_INSTRUMENT_ALERT_WITH_COLOR:8
                                            { %! REDUNDANT_INSTRUMENT_ALERT_WITH_COLOR:8
                                                \with-color %! REDUNDANT_INSTRUMENT_ALERT_WITH_COLOR:8
                                                    ...
                                                    \override %! REDUNDANT_INSTRUMENT_ALERT_WITH_COLOR:8
                                                        #'(box-padding . 0.75) %! REDUNDANT_INSTRUMENT_ALERT_WITH_COLOR:8
                                                        \box %! REDUNDANT_INSTRUMENT_ALERT_WITH_COLOR:8
                                                            harpsichord %! REDUNDANT_INSTRUMENT_ALERT_WITH_COLOR:8
                                            } %! REDUNDANT_INSTRUMENT_ALERT_WITH_COLOR:8
                                    }
                                }
                            \set PianoMusicStaff.instrumentName = \markup { %! REDUNDANT_INSTRUMENT_REDRAW:11
                                \hcenter-in %! REDUNDANT_INSTRUMENT_REDRAW:11
                                    #16 %! REDUNDANT_INSTRUMENT_REDRAW:11
                                    Harpsichord %! REDUNDANT_INSTRUMENT_REDRAW:11
                                } %! REDUNDANT_INSTRUMENT_REDRAW:11
                            \set PianoMusicStaff.shortInstrumentName = \markup { %! REDUNDANT_INSTRUMENT_REDRAW:11
                                \hcenter-in %! REDUNDANT_INSTRUMENT_REDRAW:11
                                    #10 %! REDUNDANT_INSTRUMENT_REDRAW:11
                                    Hpschd. %! REDUNDANT_INSTRUMENT_REDRAW:11
                                } %! REDUNDANT_INSTRUMENT_REDRAW:11
